...
**Output file(s)**:	Coordrinates of centers of the clusters from double circle fit of two rings and diamters and separation distance between tworings.(Ex- 
...
**What it does**:Selects those clusters having at least 20 localizations with a fit diameter. For example of diameter of70-150 nm, a height of 25-100 nm, and z-center of 0±200 nm.
...
**What it does**:Identifies tracks localizations within a 200 nm cube centered on an NPC centroid.
